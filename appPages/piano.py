        ...
        with theme.frame("- PIANO -"):
            ...
            with ui.row().classes("w-full no-wrap"):
                ...
                ui.number(
                    label="WEIGHT",
                    value="",
                    on_change=lambda e: u_frontlineRaiseWeight.set_value(e.value),
                ).classes("w-1/4 text-base").props(
            ...
            with ui.row().classes("w-full no-wrap"):
                ...
                ui.number(
                    label="WEIGHT",
                    value="",
                    on_change=lambda e: u_shoulderPressWeight.set_value(e.value),
                ).classes("w-1/4 text-base").props(
            ...
            with ui.row().classes("w-full no-wrap"):
                ui.label("Supinating Bicep Curl").classes("w-1/4 text-base").style(
                    'font-style: normal, font-family : "Atkinson Hyperlegible"'
                )
                ui.number(
                    label="REPS",
            ...
            with ui.row().classes("w-full no-wrap"):
                ...
                ui.number(
                    label="REPS",
                    value="",
                    on_change=lambda e: u_closeGripPushupReps.set_value(e.value),
                ).classes("w-1/4 text-base").props(
                ...
                ui.number(
                    label="SETS",
                    value="",
                    on_change=lambda e: u_closeGripPushupSets.set_value(e.value),
                ).classes("w-1/4 text-base").props(
                ...
                ui.number(
                    label="STAIR",
                    value="",
                    on_change=lambda e: u_closeGripPushupWeight.set_value(e.value),
                ).classes("w-1/4 text-base").props(
                    'aria-label="Close Grip Pushup Stair"'
                ).style('font-style: normal, font-family : "Atkinson Hyperlegible"')
            with ui.row().classes("w-full no-wrap"):
                ui.label("Seated Rear Delt Fly").classes("w-1/4 text-base").style(
                    'font-style: normal, font-family : "Atkinson Hyperlegible"'
                )
                ui.number(
                    label="REPS",
            ...
            with ui.row().classes("w-full no-wrap"):
                ...
                ).classes("w-1/4 text-base").props('aria-label="Side Bend Reps"').style(
                    'font-style: normal, font-family : "Atkinson Hyperlegible"'
                )
                ui.number(
                    label="SETS",
                ...
                ).classes("w-1/4 text-base").props('aria-label="Side Bend Sets"').style(
                    'font-style: normal, font-family : "Atkinson Hyperlegible"'
                )
                ui.number(
                    label="WEIGHT",
            ...
            with ui.row().classes("w-full no-wrap"):
                ui.label("Long Lever Crunches").classes("w-1/4 text-base").style(
                    'font-style: normal, font-family : "Atkinson Hyperlegible"'
                )
                ui.number(
                    label="REPS",
                    value="",
                    on_change=lambda e: u_longLeverCrunchesReps.set_value(e.value),
                ).classes("w-1/4 text-base").props(
                    'aria-label="Calf Raise Reps"'
                ).style('font-style: normal, font-family : "Atkinson Hyperlegible"')
                ui.number(
                    label="SETS",
                    value="",
                    on_change=lambda e: u_longLeverCrunchesSets.set_value(e.value),
                ).classes("w-1/4 text-base").props(
                    'aria-label="Calf Raise Sets"'
                ).style('font-style: normal, font-family : "Atkinson Hyperlegible"')
                ui.label("").classes("w-1/4 text-base").style(
            ...
            with ui.row().classes("w-full no-wrap"):
                ...
                ui.number(
                    label="Distance",
                    value="",
                    on_change=lambda e: u_walkDistance.set_value(math.ceil(e.value)),
                ).classes("w-1/4 text-base").style(
                    'font-style: normal, font-family : "Atkinson Hyperlegible"'
                )
                ui.label(" ").classes("w-1/4 text-base").style(
