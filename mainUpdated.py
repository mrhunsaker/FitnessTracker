...
def main():
    ...
    sql_create_lowerbody_table = """CREATE TABLE IF NOT EXISTS LOWERBODY (
        ...
        SLIDERHAMSTRINGCURL_WEIGHT 	INTEGER NOT NULL,
...
class upperBody(scrolled.ScrolledPanel):
    ...
    def save(
        ...
        downdogPushupReps = self.frontlineRaiseReps.GetValue()
        downdogPushupSets = self.frontlineRaiseReps.GetValue()
        downdogPushupWeight = self.frontlineRaiseReps.GetValue()
        shoulderPressReps = self.frontlineRaiseReps.GetValue()
        shoulderPressSets = self.frontlineRaiseReps.GetValue
        shoulderPressWeight = self.frontlineRaiseReps.GetValue()
        elbowOutRowReps = self.frontlineRaiseReps.GetValue()
        elbowOutRowSets = self.frontlineRaiseReps.GetValue
        elbowOutRowWeight = self.frontlineRaiseReps()
        bicepCurlReps = self.frontlineRaiseReps.GetValue()
        bicepCurlSets = self.frontlineRaiseReps.GetValue
        bicepCurlWeight = self.frontlineRaiseReps()
        closeGripPushupReps = self.frontlineRaiseReps.GetValue()
        closeGripPushupSets = self.frontlineRaiseReps.GetValue
        closeGripPushupWeight = self.frontlineRaiseReps()
        rearDeltFlyReps = self.frontlineRaiseReps.GetValue()
        rearDeltFlySets = self.frontlineRaiseReps.GetValue
        rearDeltFlyWeight = self.frontlineRaiseReps()
        sideBendReps = self.frontlineRaiseReps.GetValue()
        sideBendSets = self.frontlineRaiseReps.GetValue
        sideBendWeight = self.frontlineRaiseReps()
        lateralRaiseReps = self.frontlineRaiseReps.GetValue()
        lateralRaiseSets = self.frontlineRaiseReps.GetValue
        lateralRaiseWeight = self.frontlineRaiseReps()
...
class lowerBody(scrolled.ScrolledPanel):
    ...
    def show(self,event):
        ...
        df = df.rename(
                columns = {
                        ...
                        'SLIDERHAMSTRINGCURL_WEIGHT': 'Slider Hamstring Curl weight',
    ...
    def save(
        ...
        hamstringCurlWeight = self.hamstringCurlWeight.GetValue()
